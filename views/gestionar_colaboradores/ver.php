    ...
    <?php if ($colaborador): ?>
        ...
        <div style="display:flex;align-items:center;gap:12px;">
            <?php if (!empty($colaborador['foto_perfil'])): ?>
                <?php $fotoPath = ltrim($colaborador['foto_perfil'], '/'); // evita doble slash ?>
                <!-- Miniatura redonda de la foto -->
...
<?php if ($colaborador): ?>
    <!-- Layout a dos columnas: datos personales y cargo -->
    <div class="grid two-cols">
        ...
        <div>
            ...
            <?php else: ?>
                <!-- CTA para asignar cargo si no tiene uno activo -->
